...
//====================================================================================
//configuration.setLanguageModelPath("src/resources/edu/cmu/sphinx/models/en-us/en-us.lm.bin");
...
startSpeechRecognition();
    ...
    public void makeDecision(String speech , List<WordResult> speechWords) {
        chatboxTextPane.setText(chatboxTextPane.getText()+"You : "+speech+"\n");
        
        String response=chatbotResponse.getResponse(speech);
        if(!response.equals("")){
